																		...
																		<div class="wpb_revslider_element wpb_content_element">
																			<div id="main-slider" class="fullwidthbanner-container" style="margin: 0px auto; padding: 0px; max-width: 612px; background-color: transparent;">
																				<div class="module slideshow no-margin">
																					...
																					<div class="item">
																						<a href="#"><img src="{{asset('images/frontend_image/banner/'.$slide->image)}}" alt="slider1" class="img-responsive" /></a>
																					</div>
																					@endforeach
																				</div>
                 ...
                 success:function(resp){
                   if(resp=="Exists"){
                       ...
                       $("#statusSubcribe").html("<font color='red'>Email Not Valid</font>");
                   	  ...
                   	  $("#statusSubcribe").html("<font color='white'>Email Successfully Sent</font>");
                   }
