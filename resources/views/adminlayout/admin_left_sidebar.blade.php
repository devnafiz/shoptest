<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
       ...
       <a> <!-- <a href="index.html"><img src="assets/images/logo.svg" width="25" alt="Aero"> --><span class="m-l-10">Shoppersmaaza</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-apps"></i><span>Bannar</span></a>
                <ul class="ml-menu">
                    <li><a href="{{url('/admin/view-slide')}}">Home Slider</a></li>
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Category</span></a>
                <ul class="ml-menu">
                    ...
                    <li><a href="{{url('/admin/view-category')}}">Category List</a></li>
                    
                </ul>
            </li>
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-folder"></i><span>Page Manager</span></a>
                <ul class="ml-menu">
                    <li><a href="{{url('/admin/page-list')}}">All Page</a></li>
                    <li><a href="{{url('/admin/add-page')}}">Create Page</a></li>
                    <li><a href="{{url('/admin/image-list')}}">Editor Images</a></li>
                    <li><a href="{{url('/admin/add-image')}}">Add Editor Image</a></li>
                </ul>
            </li>
          @if(Session::get('adminDetails')['users_access']==1)
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-flower"></i><span>Admin/Sub Admin</span></a>
                <ul class="ml-menu">
                    <li><a href="{{url('/admin/view-admin')}}">Admin List</a></li>
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>Ecommerce</span></a>
                <ul class="ml-menu">
                    ...
                    <li><a href="{{url('/admin/tag-list')}}">Tags</a> </li>
