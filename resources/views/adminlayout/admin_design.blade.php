...
<title> Shoppersmaaza:: Home</title>
...
@include('adminlayout.admin_right_sidebar');

<!-- Left Sidebar -->
@include('adminlayout.admin_left_sidebar');
<!-- Right Sidebar -->
    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Dashboard</h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> Shoppersmaaza</a></li>
