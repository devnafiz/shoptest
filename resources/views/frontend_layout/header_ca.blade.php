							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 sl-header-text">
								<div class="offer-wrapper">
									<div class="offer-header">
										<ul id="offer-info">
											<li>
												<i class="sp-ic fa fa-phone-square">&nbsp;</i>Telephone: <a title="0123 456 7891" href="#">+880-1755962727</a> 
											</li>
											
											<li>
												<i class="sp-ic fa fa-envelope">&nbsp;</i>E-mail: <a title="Contact@domain.com" href="mailto:shoppersmaaza@gmail.com">shoppersmaaza@gmail.com</a>
											</li>
										</ul>
									</div>
								</div>
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-2 col-sm-12 col-xs-12 logo-wrapper">
								<a href="home_style_1.html">
									<img src="{{asset('images/logo.png')}}" alt="sw shoppy" width="140" height="57"/>
								</a>
							</div>
							<!-- END LOGO -->
											...
											<div class="navbar-inner navbar-inverse">
														...
														<ul id="menu-primary-menu" class="flytheme_resmenu">
															...
															<li class="res-dropdown menu-pages">
																...
																<ul class="dropdown-resmenu">
																	...
																	<li class="active res-dropdown menu-about-us">
																		<a class="item-link dropdown-toggle" href="#">About Us</a>
																		<span class="show-dropdown"></span>
																		
																		<ul class="dropdown-resmenu">
																			<li class="active menu-about-us-1">
												...
												<ul id="menu-primary-menu-1" class="nav nav-pills nav-mega flytheme-menures">
													...
													<li class="dropdown menu-shop ya-mega-menu level1">
														<a href="{{url('/products')}}" class="item-link ">
															<span class="have-title">
														...
														<li class="dropdown menu-computers-networking ya-menu-custom level1">
															...
															<ul class="dropdown-menu nav-level1 one-column">
																...
																<li class="one-column menu-lorem-sed-fringilla">
																	<a href="#">
																		<span class="have-title">
																			<span class="menu-title">{{$sub_cat->name}}</span>
																		</span>
																	</a>
																</li>
																@endforeach
